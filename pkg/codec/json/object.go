...
func NewObject(message specs.Message, store references.Store) *Object {
	return &Object{
		message: message,
		store:   store,
		length:  len(message),
...
func (object *Object) UnmarshalJSONObject(decoder *gojay.Decoder, key string) error {
	...
	return decodeElement(decoder, key, property.Template, object.store)
}

// NKeys returns the amount of available keys inside the given object.
func (object *Object) NKeys() int { return object.length }

// IsNil returns whether the given object is null or not.
func (object *Object) IsNil() bool { return object == nil }
